...
class ExceptionHandlingController : ErrorController {
    ...
    // 에러 페이지 정의
    private val ERROR_404_PAGE_PATH = "/error/404"
    private val ERROR_500_PAGE_PATH = "/error/500"
    private val ERROR_ETC_PAGE_PATH = "/error/error"
    ...
    fun handleError(request: HttpServletRequest, model: Model): String {
        ...
        if (status != null) {
            ...
            if (statusCode == HttpStatus.NOT_FOUND.value()) {
                ...
                model.addAttribute("msg", httpStatus.reasonPhrase)
